...
var BlankIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var DropdownItem = React4.memo(function(props) {
  ...
  var iconRenderer = function iconRenderer2() {
    if (selected) {
      ...
      return React4.createElement(CheckIcon, checkIconProps);
    }
    var blankIconProps = mergeProps({
      className: cx("blankIcon")
    }, getPTOptions("blankIcon"));
    return React4.createElement(BlankIcon, blankIconProps);
  };
  return React4.createElement("li", itemProps, checkmark && iconRenderer(), React4.createElement("span", itemGroupLabelProps, content), React4.createElement(Ripple, null));
});
  ...
  var createItem = function createItem2(option, index) {
    ...
    if (option.group && props.optionGroupLabel) {
      ...
      return React4.createElement("li", _extends4({
        key
      }, itemGroupProps), React4.createElement("span", itemGroupLabelProps, groupContent));
    }
...
var Dropdown = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React4.useState(""), _React$useState2 = _slicedToArray2(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React4.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React4.useState(-1), _React$useState6 = _slicedToArray2(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React4.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
  var clickedRef = React4.useRef(false);
  var elementRef = React4.useRef(null);
  var overlayRef = React4.useRef(null);
  var firstHiddenFocusableElementOnOverlay = React4.useRef(null);
  var lastHiddenFocusableElementOnOverlay = React4.useRef(null);
  ...
  var createLabel = function createLabel2() {
    ...
    if (props.editable) {
      ...
      return React4.createElement("input", _inputProps);
    }
    ...
    return React4.createElement("span", inputProps, content);
  };
  ...
  var createLoadingIcon = function createLoadingIcon2() {
    ...
    var icon = props.loadingIcon || React4.createElement(SpinnerIcon, {
      spin: true
    });
    ...
    return React4.createElement("div", loadingButtonProps, loadingIcon);
  };
  ...
  return React4.createElement(React4.Fragment, null, React4.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React4.createElement(DropdownPanel, _extends4({
    ...
    firstFocusableElement: React4.createElement("span", firstHiddenFocusableElementProps),
    lastFocusableElement: React4.createElement("span", lastHiddenFocusableElementProps),
    sx
